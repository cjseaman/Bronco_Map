...
/*
GLOBAL VARIABLES FROM HOUSES.js
...
//Sets center and zoom and sets map variable from events.js
...
//Controls action on list click
//i = index of list element clicked
	function clickList (school, i) {
		
  		switchWindow(school, i);
...
//Tracks last list item clicked and removes its window and marker on click
	function switchWindow (school, i) {
	...
	function switchMarker (school, i) {
